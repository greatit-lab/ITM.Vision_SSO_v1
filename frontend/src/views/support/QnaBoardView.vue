  ...
  <div>
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
      ...
      <button 
        ...
        class="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg text-sm font-bold shadow-md transition-all flex items-center gap-2"
      >
        <i class="pi pi-pencil"></i> 질문 작성
      </button>
    </div>

    <div class="bg-white dark:bg-zinc-900 rounded-lg p-2.5 shadow-sm border border-slate-200 dark:border-zinc-800 mb-4 flex flex-col md:flex-row gap-3 justify-between items-center">
      <div class="flex p-1 bg-slate-100 dark:bg-zinc-800 rounded-md">
        <button 
      ...
      <div class="relative w-full md:w-64 group">
        ...
        <input 
          ...
          type="text" 
          placeholder="검색어 입력..." 
          class="w-full pl-8 pr-3 py-1.5 bg-slate-50 dark:bg-zinc-800 border border-transparent focus:bg-white dark:focus:bg-zinc-900 focus:border-indigo-500 rounded-md text-xs outline-none transition-all placeholder:text-slate-400"
        >
      </div>
    </div>

    <div class="bg-white dark:bg-zinc-900 rounded-lg shadow-sm border border-slate-200 dark:border-zinc-800 overflow-hidden">
      
      <div class="flex items-center justify-between p-2.5 bg-white border-b border-slate-100 dark:border-zinc-800 dark:bg-zinc-900">
      ...
      <table v-else class="w-full text-xs text-left">
        <thead class="bg-slate-50 dark:bg-zinc-800 text-slate-500 dark:text-slate-400 font-medium border-b border-slate-200 dark:border-zinc-700">
          <tr>
        ...
        <tbody class="divide-y divide-slate-100 dark:divide-zinc-800">
          ...
          >
            ...
            <td class="px-3 py-2.5 text-center text-slate-600 dark:text-slate-400 truncate max-w-[100px]">{{ post.authorId }}</td>
