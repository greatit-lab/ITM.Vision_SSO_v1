...
<template>
  <div class="flex flex-col h-full w-full font-sans bg-[#F8FAFC] dark:bg-[#09090B] p-4 md:p-6 overflow-hidden">
    ...
    <div class="flex flex-col flex-1 min-h-0 gap-5 animate-fade-in" style="animation-delay: 0.1s">
              ...
              <div>
                ...
                <div class="flex flex-wrap items-center gap-4 mt-5 text-xs font-medium text-slate-400">
                  ...
                  <div class="flex items-center gap-1.5 text-emerald-600 dark:text-emerald-500">
                    <i class="pi pi-verified"></i> Stable Release
                  </div>
                </div>
              </div>
        ...
        <div class="bg-white dark:bg-[#111111] border border-slate-200 dark:border-zinc-800 rounded-2xl p-0 shadow-sm flex flex-col h-full overflow-hidden">
          ...
          <div class="flex flex-col flex-1 gap-4 px-5 pt-5 pb-3 overflow-y-auto">
            <div class="relative pl-5 border-l-2 border-indigo-300 dark:border-indigo-600">
              ...
              <ul class="ml-3 space-y-1 text-xs leading-relaxed list-disc list-outside text-slate-600 dark:text-slate-400">
            ...
            <div class="relative pl-5 border-l-2 border-slate-200 dark:border-zinc-700">
              ...
              <ul class="ml-3 space-y-1 text-xs leading-relaxed list-disc list-outside text-slate-500 dark:text-slate-500">
                <li>초기 안정화 버전 릴리즈</li>
                <li>네트워크 단절 대비 로컬 데이터 캐싱(Caching) 파일 암호화 적용</li>
      ...
      <div class="w-full mt-1 shrink-0">
        <div class="flex items-center justify-between px-1 pb-2 mb-3 border-b border-slate-200 dark:border-zinc-800">
          ...
          <span class="text-sm font-medium text-slate-500 dark:text-slate-400">장비 특성에 맞춘 분석 모듈을 개별로 다운로드하세요.</span>
        </div>
          ...
          >
            <div class="flex items-start justify-between gap-2 mb-3 shrink-0">
              <div class="flex items-center gap-2.5 overflow-hidden">
                <div :class="`w-9 h-9 rounded-lg flex items-center justify-center shrink-0 ${plugin.bg}`">
                  <i :class="`pi ${plugin.icon} ${plugin.color} text-sm`"></i>
                </div>
                <h4 class="text-[12px] font-bold text-slate-800 dark:text-slate-200 truncate" :title="plugin.name">
                  {{ plugin.name }}
                </h4>
              </div>
              <span class="text-[9px] text-slate-400 font-mono tracking-wider bg-slate-50 dark:bg-zinc-800/80 border border-slate-100 dark:border-zinc-700 px-1.5 py-0.5 rounded shrink-0 mt-0.5">
                {{ plugin.version }}
              </span>
            </div>

            <p class="text-[11px] text-slate-500 dark:text-slate-400 leading-relaxed mb-4 line-clamp-3 flex-1" :title="plugin.description">
              {{ plugin.description }}
            </p>
