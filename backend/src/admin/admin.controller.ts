...
export class AdminController {
  ...
  @Get('users') async getUsers() { return this.adminService.getAllUsers(); }
  @Get('admins') async getAdmins() { return this.adminService.getAllAdmins(); }
  ...
  @Delete('guests/:id') async deleteGuest(@Param('id') id: string) { return this.adminService.deleteGuest(id); }

  @Get('requests') async getGuestRequests() { return this.adminService.getGuestRequests(); }
  @Post('requests/approve') async approveGuestRequest(@Body() body: ApproveGuestRequestDto) { return this.adminService.approveGuestRequest(body); }
  @Post('requests/reject') async rejectGuestRequest(@Body() body: RejectGuestRequestDto) { return this.adminService.rejectGuestRequest(body); }

  @Get('severity') async getSeverities() { return this.adminService.getSeverities(); }
  @Post('severity') async createSeverity(@Body() body: CreateSeverityDto) { return this.adminService.createSeverity(body); }
  @Put('severity/:errorId') async updateSeverity(@Param('errorId') errorId: string, @Body() body: UpdateSeverityDto) { return this.adminService.updateSeverity(errorId, body); }
  ...
  @Post('metrics') async createMetric(@Body() body: CreateMetricDto) { return this.adminService.createMetric(body); }
  @Put('metrics/:name') async updateMetric(@Param('name') name: string, @Body() body: UpdateMetricDto) { return this.adminService.updateMetric(name, body); }
  @Delete('metrics/:name') async deleteMetric(@Param('name') name: string) { return this.adminService.deleteMetric(name); }

  @Get('equipments') async getEquipments() { return this.adminService.getRefEquipments(); }

  @Get('new-server') async getNewServerConfig() { return this.adminService.getNewServerConfig(); }
  @Put('new-server') async updateNewServerConfig(@Body() body: UpdateNewServerDto) { return this.adminService.updateNewServerConfig(body); }
  @Get('servers') async getCfgServers() { return this.adminService.getCfgServers(); }
  @Post('servers') async createCfgServer(@Body() body: CreateCfgServerDto) { return this.adminService.createCfgServer(body); }
